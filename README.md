...
<p align="center">
  <img src="viz/compare_03_id880.jpg" width="900" alt="3패널 비교 id880"/>
  <br/>
  <em>[1] Ground Truth (사람이 단 정답) · [2] v0.2 전이학습 (17도시 다중 학습) · [3] COCO 사전학습 (사실상 백지).</em>
</p>

<p align="center">
  <img src="viz/compare_06_id830.jpg" width="900" alt="3패널 비교 id830"/>
  <br/>
  <em>같은 형식 — 다른 청라 10m val 프레임. v0.2가 다양한 도시 학습 후 청라에서도 일관된 검출.</em>
</p>
